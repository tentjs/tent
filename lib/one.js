...
class One {
    ...
    for (const el of iterator) {
      ...
      Array.from(el.attributes).forEach(attr => {
        ...
        if (
          ...
          !attr.name.startsWith('o-text') &&
          !attr.name.startsWith('o-for') &&
          !attr.name.startsWith('o-model') &&
          !attr.name.startsWith('o-if') &&
          !attr.name.startsWith('o-scope') &&
          !attr.name.startsWith('o-key') &&
  ...
  async mount () {
    ...
    this.#scope.removeAttribute('o-scope')
