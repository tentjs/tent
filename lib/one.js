...
function setAttrs (el, attrs, from = null) {
  // TODO: Save the attributes on $one.attrs in the same format,
  // so that this if statement can be removed
  if (from) {
